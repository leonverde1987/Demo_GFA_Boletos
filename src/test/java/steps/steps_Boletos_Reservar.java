...
public class steps_Boletos_Reservar extends genericGrid{
    ...
    public void ingresar_A_URL(RemoteWebDriver driver, int contador, Properties Config, String Escenario, String navegador) throws FileNotFoundException, InterruptedException {
        try{
            this.abrirURl(driver, Config.getProperty("urlAppBoletos"));
    ...
    /**
     * Esté método nos ingresa origen del viaje.
     * @param driver Elemento WebDriver de la prueba.
     ...
     * @throws InterruptedException Cacha si el archivo Config no existe. 
     */
    public void ingresar_Origen(RemoteWebDriver driver, String textoBuscar, int contador, Properties Config, Properties Elementos, String Escenario, String navegador) throws FileNotFoundException, InterruptedException {
        this.ingresar_texto(driver, "xpath", Elementos.getProperty("xpath_txt_BuscarOrigen"), textoBuscar);
        this.capturaDriver(driver, Config.getProperty("rutaEvidencia"), contador, Escenario, navegador);
    }
    
    /**
     * Esté método nos ayuda a ingresar origen del viaje.
     * @param driver Elemento WebDriver de la prueba.
     * @param textoBuscar Es el valor del texto que se va ingresar al componente.
     * @param contador Es el controlador de pasos ejecutados.
     * @param Config Es el archivo de configuración de la prueba.
     ...
     * @throws InterruptedException Cacha si el archivo Config no existe. 
     */
    public void ingresar_Destino(RemoteWebDriver driver, String textoBuscar, int contador, Properties Config, Properties Elementos, String Escenario, String navegador) throws FileNotFoundException, InterruptedException {
        this.ingresar_texto(driver, "xpath", Elementos.getProperty("xpath_txt_BuscarDestino"), textoBuscar);
        this.capturaDriver(driver, Config.getProperty("rutaEvidencia"), contador, Escenario, navegador);
    }
     ...
     * @throws InterruptedException Cacha si el archivo Config no existe. 
     */
    public void presionar_Buscar(RemoteWebDriver driver, int contador, Properties Config, Properties Elementos, String Escenario, String navegador) throws InterruptedException{
        this.clic_btn(driver, "xpath", Elementos.getProperty("xpath_btn_Buscar"));
        this.capturaDriver(driver, Config.getProperty("rutaEvidencia"), contador, Escenario, navegador);
    }
     ...
     * @param contador Es el controlador de pasos ejecutados.
     * @param Config Es el archivo de configuración de la prueba.
     * @param Elementos Es el archivo de configuración de los selectores selenium.
     * @param Escenario Es el nombre del caso de prueba.
